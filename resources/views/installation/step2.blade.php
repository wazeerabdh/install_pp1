...
@section('content')
    ...
    <div class="pb-2">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Grofresh Software Installation"
            ...
            <div class="progress-bar w-40-percent"></div>
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            <p class="mb-4">{{ translate('Provide your') }} <strong>{{ translate('username') }}</strong> {{ translate('of codecanyon & the') }} <strong>{{ translate('purchase code') }}</strong> </p>
                ...
                <div class="bg-light p-4 rounded mb-4">
                    ...
                    <div class="px-xl-2 pb-sm-3">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="from-group">
                                    <label for="purchase_key" class="d-flex align-items-center gap-2 mb-2">
                                        <span class="fw-medium">{{ translate('Purchase Code') }}</span>
                                        <span class="cursor-pointer" data-bs-toggle="tooltip"
                                              data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                              data-bs-html="true"
